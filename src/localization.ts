...
export const translations: Record<LanguageCode, {
  ...
  en: {
    ...
    doctor: "Specialist",
    admin: "Assessor",
    twoFAHeader: "Two-Factor Authentication GDPR",
    twoFADesc: "A temporary one-time password has been sent to your secure messaging channels.",
    tempToken: "Temporary OTP Security Token (Demo):",
    enterOtp: "Enter the one-time security code",
    verifySession: "Verify Secure GDPR Session",
    activeCaseAuditId: "ACTIVE CASE AUDIT ID",
    caseLabel: "Case",
    documentsReceived: "Documents received",
    underPreScreening: "Under pre-screening",
    inProgressWithExpert: "In progress with expert",
    conclusionReady: "Conclusion ready",
    slaQueueLabel: "Assigned Cases (SLA Queue)",
    noAssignedCases: "No assigned cases found.",
    askQuestion: "Ask a question...",
    pacsWorkstation: "PACS WORKSTATION-VIEWER",
    pacsCalibration: "PACS Calibration",
    brightnessLabel: "Window Level (Brightness)",
    contrastLabel: "Window Width (Contrast)",
    scaleCaliper: "Scale & Caliper",
    scaleUp: "Scale Up",
    scaleDown: "Scale Down",
    slaRulerMeasure: "SLA Ruler Measure (2D)",
    calibrated: "Calibrated",
    clickTwiceText: "Click twice on the slice view to record cardiac mitral valve leaks or neurological cortical thickness in millimeters.",
    caliperActive: "Caliper Active",
    caliperStopped: "Caliper Stopped",
    clearCalipers: "Clear",
    resetPacs: "Reset Parameters",
    slices: "Slice",
    sliceStack: "Slice stack",
    pacsRuler: "SLA RULER",
    readyClickMeasure: "READY (CLICK TO MEASURE)",
    disabled: "DISABLED",
    caliperMetrics: "Caliper Metrics",
    passwordDesc: "Default login password is 123456",
    pacsPatient: "PATIENT",
    slaSync: "SLA SYNC ACTIVE"
  },
  de: {
    brand: "EuroSecondOpinion",
    ...
    doctor: "Facharzt",
    admin: "Assessor",
    twoFAHeader: "Zwei-Faktor-Authentifizierung DSGVO",
    twoFADesc: "Ein temporäres Einmalpasswort wurde an Ihre sicheren Nachrichtenkanäle gesendet.",
    tempToken: "Temporäres OTP-Sicherheitstoken (Demo):",
    enterOtp: "Geben Sie den Einmalcode ein",
    verifySession: "Sichere DSGVO-Sitzung verifizieren",
    activeCaseAuditId: "AKTIVE FALL-AUDIT-ID",
    caseLabel: "Fall",
    documentsReceived: "Dokumente empfangen",
    underPreScreening: "In Vorprüfung",
    inProgressWithExpert: "In Bearbeitung beim Experten",
    conclusionReady: "Gutachten bereit",
    slaQueueLabel: "Zugewiesene Fälle (SLA)",
    noAssignedCases: "Keine zugewiesenen Fälle gefunden.",
    askQuestion: "Frage stellen...",
    pacsWorkstation: "PACS-WORKSTATION-VIEWER",
    pacsCalibration: "PACS-Kalibrierung",
    brightnessLabel: "Fensterstufe (Helligkeit)",
    contrastLabel: "Fensterbreite (Kontrast)",
    scaleCaliper: "Skalierung & Sattel",
    scaleUp: "Vergrößern",
    scaleDown: "Verkleinern",
    slaRulerMeasure: "SLA-Lineal-Messung (2D)",
    calibrated: "Kalibriert",
    clickTwiceText: "Doppelklicken Sie auf die Schnittansicht, um Mitralklappenlecks oder kortikale Dicke in Millimetern aufzuzeichnen.",
    caliperActive: "Kaliber Aktiv",
    caliperStopped: "Kaliber Gestoppt",
    clearCalipers: "Löschen",
    resetPacs: "Parameter zurücksetzen",
    slices: "Schnitt",
    sliceStack: "Schnittstapel",
    pacsRuler: "SLA-LINEAL",
    readyClickMeasure: "BEREIT (KLICKEN ZUM MESSEN)",
    disabled: "DEAKTIVIERT",
    caliperMetrics: "Kaliber-Messwerte",
    passwordDesc: "Standard-Passwort ist 123456",
    pacsPatient: "PATIENT",
    slaSync: "SLA-SYNCHRONISIERUNG"
  },
  fr: {
    brand: "EuroSecondOpinion",
    ...
    doctor: "Médecin",
    admin: "Assesseur",
    twoFAHeader: "Authentification à deux facteurs RGPD",
    twoFADesc: "Un mot de passe temporaire unique a été envoyé à vos canaux de messagerie sécurisés.",
    tempToken: "Jeton de sécurité OTP temporaire (Démo) :",
    enterOtp: "Saisissez le code de sécurité à usage unique",
    verifySession: "Vérifier la session sécurisée RGPD",
    activeCaseAuditId: "ID D'AUDIT DE CAS ACTIF",
    caseLabel: "Cas",
    documentsReceived: "Documents reçus",
    underPreScreening: "Sous pré-évaluation",
    inProgressWithExpert: "En cours avec l'expert",
    conclusionReady: "Rapport médical disponible",
    slaQueueLabel: "File des cas assignés (SLA)",
    noAssignedCases: "Aucun cas assigné trouvé.",
    askQuestion: "Poser une question...",
    pacsWorkstation: "STATION DE VISUALISATION PACS",
    pacsCalibration: "Calibrage PACS",
    brightnessLabel: "Niveau de fenêtre (Luminosité)",
    contrastLabel: "Largeur de fenêtre (Contraste)",
    scaleCaliper: "Échelle et pied à coulisse",
    scaleUp: "Agrandir",
    scaleDown: "Réduire",
    slaRulerMeasure: "Mesure par règle SLA (2D)",
    calibrated: "Calibré",
    clickTwiceText: "Double-cliquez sur la vue en coupe para enregistrer les fuites de la valve mitrale ou l'épaisseur corticale en millimètres.",
    caliperActive: "Pied à coulisse actif",
    caliperStopped: "Pied à coulisse arrêté",
    clearCalipers: "Effacer",
    resetPacs: "Réinitialiser les paramètres",
    slices: "Coupe",
    sliceStack: "Pile de coupes",
    pacsRuler: "RÈGLE SLA",
    readyClickMeasure: "PRÊT (CLIQUER POUR MESURER)",
    disabled: "DÉSACTIVÉ",
    caliperMetrics: "Mesures du pied à coulisse",
    passwordDesc: "Mot de passe par défaut est 123456",
    pacsPatient: "PATIENT",
    slaSync: "SYNCHRONISATION SLA"
  },
  it: {
    brand: "EuroSecondOpinion",
    ...
    liveAIAssist: "Operatore IA in tempo reale: Rilevamento parametri discussi...",
    languageSelect: "Seleziona Paese/Lingua",
    backToDashboard: "Torna alla Dashboard",
    patient: "Paziente",
    doctor: "Medico",
    admin: "Assessore",
    twoFAHeader: "Autenticazione a due fattori GDPR",
    twoFADesc: "Una password temporanea monouso è stata inviata ai tuoi canali di messaggistica sicuri.",
    tempToken: "Token di sicurezza OTP temporaneo (Demo):",
    enterOtp: "Inserisci il codice di sicurezza monouso",
    verifySession: "Verifica la sessione sicura GDPR",
    activeCaseAuditId: "ID DI AUDIT DEL CASO ATTIVO",
    caseLabel: "Caso",
    documentsReceived: "Documenti ricevuti",
    underPreScreening: "In pre-valutazione",
    inProgressWithExpert: "In corso con l'esperto",
    conclusionReady: "Rapporto medico pronto",
    slaQueueLabel: "Coda dei casi assegnati (SLA)",
    noAssignedCases: "Nessun caso assegnato trovato.",
    askQuestion: "Fai una domanda...",
    pacsWorkstation: "STAZIONE DI VISUALIZZAZIONE PACS",
    pacsCalibration: "Calibrazione PACS",
    brightnessLabel: "Livello di finestra (Luminosità)",
    contrastLabel: "Larghezza di finestra (Contrasto)",
    scaleCaliper: "Scala e calibro",
    scaleUp: "Ingrandisci",
    scaleDown: "Rimpicciolisci",
    slaRulerMeasure: "Misurazione con righello SLA (2D)",
    calibrated: "Calibrato",
    clickTwiceText: "Fare doppio clic sulla vista a fette per registrare perdite della valvola mitrale o spessore corticale in millimetri.",
    caliperActive: "Calibro attivo",
    caliperStopped: "Calibro disattivato",
    clearCalipers: "Azzera",
    resetPacs: "Ripristina parametri",
    slices: "Fetta",
    sliceStack: "Pila di fette",
    pacsRuler: "RIGHELLO SLA",
    readyClickMeasure: "PRONTO (CLICCA PER MISURARE)",
    disabled: "DISATTIVATO",
    caliperMetrics: "Metriche del calibro",
    passwordDesc: "La password predefinita è 123456",
    pacsPatient: "PAZIENTE",
    slaSync: "SINCRONIZZAZIONE SLA"
  },
  es: {
    brand: "EuroSecondOpinion",
    ...
    doctor: "Médico",
    admin: "Asesor",
    twoFAHeader: "Autenticación de dos factores GDPR",
    twoFADesc: "Se ha enviado una contraseña temporal de un solo uso a sus canales de mensajería seguros.",
    tempToken: "Token de seguridad OTP temporal (Demo):",
    enterOtp: "Rellene el código de verificación único",
    verifySession: "Verificar sesión de seguridad GDPR",
    activeCaseAuditId: "ID DE AUDIT DE CASO ACTIVO",
    caseLabel: "Caso",
    documentsReceived: "Documentos recibidos",
    underPreScreening: "En pre-evaluación",
    inProgressWithExpert: "En curso con el experto",
    conclusionReady: "Informe médico listo",
    slaQueueLabel: "Cola de casos asignados (SLA)",
    noAssignedCases: "No se encontraron casos asignados.",
    askQuestion: "Hacer una pregunta...",
    pacsWorkstation: "ESTACIÓN DE VISUALIZACIÓN PACS",
    pacsCalibration: "Calibración PACS",
    brightnessLabel: "Nivel de ventana (Brillo)",
    contrastLabel: "Ancho de ventana (Contraste)",
    scaleCaliper: "Escala y calibre",
    scaleUp: "Aumentar",
    scaleDown: "Disminuir",
    slaRulerMeasure: "Medida con regla SLA (2D)",
    calibrated: "Calibrado",
    clickTwiceText: "Haga doble clic en la vista de corte para registrar fugas de la válvula mitral o el grosor cortical en milímetros.",
    caliperActive: "Calibre activo",
    caliperStopped: "Calibre detenido",
    clearCalipers: "Limpiar",
    resetPacs: "Restablecer parámetros",
    slices: "Corte",
    sliceStack: "Pila de cortes",
    pacsRuler: "REGLA SLA",
    readyClickMeasure: "LISTO (CLIC PARA MEDIR)",
    disabled: "DESACTIVADO",
    caliperMetrics: "Métricas del calibre",
    passwordDesc: "La contraseña por defecto es 123456",
    pacsPatient: "PACIENTE",
    slaSync: "SINCRONIZACIÓN SLA"
  },
  ru: {
    brand: "EuroSecondOpinion",
    ...
    doctor: "Врач",
    admin: "Асессор",
    twoFAHeader: "Двухфакторная авторизация GDPR",
    twoFADesc: "На ваш защищённый адрес выслан временный одноразовый OTP-токен авторизации.",
    tempToken: "Временный токен авторизации (демо):",
    enterOtp: "Введите одноразовый проверочный код",
    verifySession: "Верифицировать DSGVO сессию",
    activeCaseAuditId: "АКТИВНЫЙ ИД КЕЙСА",
    caseLabel: "Кейс",
    documentsReceived: "Документы получены",
    underPreScreening: "Пре-скрининг асессора",
    inProgressWithExpert: "В работе у эксперта",
    conclusionReady: "Заключение готово",
    slaQueueLabel: "Пациенты на разборе (SLA Queue)",
    noAssignedCases: "Назначенных кейсов не найдено.",
    askQuestion: "Задать вопрос...",
    pacsWorkstation: "PACS СТАНЦИЯ-ВЬЮЕР",
    pacsCalibration: "PACS Калибровка",
    brightnessLabel: "Уровень яркости (Brightness)",
    contrastLabel: "Ширина контраста (Contrast)",
    scaleCaliper: "Масштаб и калиперы",
    scaleUp: "Увеличить",
    scaleDown: "Уменьшить",
    slaRulerMeasure: "SLA линейка измерения (2D)",
    calibrated: "Калибровано",
    clickTwiceText: "Кликните дважды на снимок для измерения толщины коры или регургитации клапана в миллиметрах.",
    caliperActive: "Калипер активен",
    caliperStopped: "Калипер отключен",
    clearCalipers: "Очистить",
    resetPacs: "Сбросить PACS",
    slices: "Снимок",
    sliceStack: "Серия снимков",
    pacsRuler: "SLA ЛИНЕЙКА",
    readyClickMeasure: "ГОТОВА (КЛИКНИТЕ ДЛЯ ИЗМЕРЕНИЯ)",
    disabled: "ОТКЛЮЧЕНА",
    caliperMetrics: "Показания калипера",
    passwordDesc: "Регистрационный пароль по умолчанию: 123456",
    pacsPatient: "ПАЦИЕНТ",
    slaSync: "СИНХРОНИЗАЦИЯ SLA"
  }
};
